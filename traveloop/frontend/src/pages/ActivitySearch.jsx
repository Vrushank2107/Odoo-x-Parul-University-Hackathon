...
const ActivitySearch = () => {
  ...
  const priceRanges = [
    ...
    { id: 'moderate', name: 'Moderate ($50-150)' },
    { id: 'expensive', name: 'Expensive ($150+)' }
  ]
  ...
  const activities = [
    {
      ...
      rating: 4.8,
      reviews: 2456,
      image: 'https://images.unsplash.com/photo-1511739001486-6bfe10ba96a5?w=400&h=250&fit=crop',
    ...
    },
    {
      ...
      rating: 4.9,
      reviews: 1823,
      image: 'https://images.unsplash.com/photo-1556022462-3e6b3cc2cc5a?w=400&h=250&fit=crop',
    ...
    },
    {
      ...
      rating: 4.9,
      reviews: 1567,
      image: 'https://images.unsplash.com/photo-1590720148493-6839151cd5d0?w=400&h=250&fit=crop',
    ...
    },
    {
      ...
      rating: 4.8,
      reviews: 892,
      image: 'https://images.unsplash.com/photo-1504674900247-0877249b2531?w=400&h=250&fit=crop',
    ...
    },
    {
      ...
      rating: 4.6,
      reviews: 5234,
      image: 'https://images.unsplash.com/photo-1590143237491-1db5ff5b8c7a?w=400&h=250&fit=crop',
  ...
  const getFilteredActivities = () => {
    ...
    if (priceRange !== 'all') {
      if (priceRange === 'free') {
        ...
        filtered = filtered.filter(activity => activity.price > 0 && activity.price <= 50)
      } else if (priceRange === 'moderate') {
        filtered = filtered.filter(activity => activity.price > 50 && activity.price <= 150)
      } else if (priceRange === 'expensive') {
        filtered = filtered.filter(activity => activity.price > 150)
      }
    }
